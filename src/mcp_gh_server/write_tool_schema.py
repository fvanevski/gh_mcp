...
WRITE_TOOL_METADATA: dict[str, WriteToolMetadata] = {
    ...
    "gh_run_workflow_exact": WriteToolMetadata(
        ...
        (
            ...
            "and an existing nonterminal workflow_dispatch run for the workflow/head, "
            "accepts only a bounded typed input object, requests return_run_details, and binds "
            "authoritative "
