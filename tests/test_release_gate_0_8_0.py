"""Immutable historical release record for version 0.8.0."""
...
HISTORICAL_SURFACE = "Version 0.8.0 exposes 58 public MCP tools: 40 read-only and 18 write."
RELEASE_WRITE_TOOLS = {
    "gh_commit_files",
    "gh_create_branch",
...
def test_release_document_preserves_historical_surface() -> None:
    """Keep the shipped 0.8.0 record immutable as current runtime authority advances."""

    gate = (ROOT / "docs" / "release_gate_0_8_0.md").read_text()
