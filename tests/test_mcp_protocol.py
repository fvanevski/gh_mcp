...
async def test_registered_tool_schemas_and_annotations() -> None:
    ...
    assert "gh_list_repository_tree" in tools
    ...
    assert tools["gh_list_repository_tree"].annotations.read_only_hint is True
    assert tools["gh_list_repository_tree"].annotations.destructive_hint is False
    assert tools["gh_list_repository_tree"].annotations.idempotent_hint is True
    assert tools["gh_list_repository_tree"].annotations.open_world_hint is True
