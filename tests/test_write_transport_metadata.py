...
def test_release_documentation_describes_current_090_inventory() -> None:
    ...
    assert "Version 0.9.0 exposes 64 public MCP tools: 43 read-only and 21 write." in readme
    assert "Version 0.9.0 exposes 21 public GitHub write tools" in contract
    assert "64 total public MCP tools: 43 read-only and 21 write" in contract
