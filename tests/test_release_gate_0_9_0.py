...
def test_release_documentation_matches_runtime_authority() -> None:
    ...
    surface = "Version 0.9.0 exposes 64 public MCP tools: 43 read-only and 21 write."
    contract_surface = "64 total public MCP tools: 43 read-only and 21 write"
    ...
    assert "exact 64/43/21 tool inventory" in agents
